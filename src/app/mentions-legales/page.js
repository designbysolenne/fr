            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-md-12 col-lg-12 text-md-start text-center py-6">
                        ...
                        <p className="mb-2 fw-medium">Le site Design By Solenne (ci-après "le Site"), accessible à
                            l’adresse
                            {/* eslint-disable-next-line react/no-unescaped-entities */}
                            https://designbysolenne.com est édité par Solenne Loury (ci-après "l'Editeur")
                        </p>
                        <ul>
